    ...
    <div class="card w-96 bg-base-100 shadow-xl">
        ...
        <div class="card-actions justify-center">
          <form onSubmit={handleSubmit(onSubmit)} class="card-actions justify-center">
            ...
            <button type="submit" class="btn btn-secondary w-full mt-5 bg-gradient-to-r from-cyan-400 to-blue-200">Login</button>
          </form>
                <p>New to Doctor's Portal? {""}
                <small></small>
                <span><Link to='/signup' class="text-primary-focus">Please Sign Up</Link></span></p> 
        </div>
